...
function dailyGuideMessages(cl,raw,people=[],history={}){
 ...
 const rolePlans=[
   ...
   {label:'conversão + pacientes que ainda não agendaram',body:'entrar na Ferramenta de Conversão e trabalhar os contatos dos últimos 45 dias, priorizando quem já demonstrou interesse; ligar ou chamar novamente até conseguir o agendamento, uma recusa clara ou uma nova data para falar'},
 ...
 group+='Plano do dia dividido em três frentes: 1) captação + agenda, 2) conversão + pacientes que ainda não agendaram dos últimos 45 dias, 3) pós-efetivação + reagendamento. À tarde vamos conferir realizado x meta e redistribuir imediatamente o que ficar abaixo.';
