...
function centralHumanMessage(raw,cl,index,total=1){
 ...
 if(/EFETIVAD[OA]S?\s*[Xx×]\s*INICIAD[OA]S?|EFETIVADOS?.{0,20}INICIADOS?/.test(u)){
   ...
   good=chair>=100;msg=open+(good?'Meta por cadeira em azul 💙! Obrigado equipe, agora é proteger esse resultado. ':'Meta por cadeira abaixo do esperado e aqui precisamos reagir 😕. ')+'Estamos em '+Math.round(chair)+'%. Plano de ação: calcular o faltam pacientes por cadeira, abrir agenda para avaliações, chamar pacientes que ainda não agendaram e faltosos e dividir uma meta objetiva entre as recepcionistas. Fazer parcial à tarde e redistribuir a busca se alguma frente não avançar.';
