...
function returnGuideText(cl,raw){
 ...
 const wins=[],alerts=[];if(a!=null)(a>=80?wins:alerts).push('aceitação '+Math.round(a)+'%');if(conv!=null)(conv>=30?wins:alerts).push('conversão '+Math.round(conv)+'%');if(app!=null)(app>=95?wins:alerts).push('app '+Math.round(app)+'%');if(chair!=null)(chair>=100?wins:alerts).push('meta por cadeira '+Math.round(chair)+'%');if(ticket!=null)(ticket>=3419.85?wins:alerts).push('ticket '+centralMoney(ticket));
